...
// io.coolcompany.helloworld:1.0.0. Feel free to use the appVersionId shown below for this tutorial.

const APP_VERSION_ID = 'io.coolcompany.helloworld:1.0.0';

// You also need to have a beacon registered to your app in order for Harbor to accept the post. Beacons have a
// beaconVersionId which follows the same convention as the appVersionId, above. Let's use: io.coolcompany.helloworld:1.0.0.
...
const BEACON_VERSION_ID = 'io.coolcompany.helloworld:1.0.0';
